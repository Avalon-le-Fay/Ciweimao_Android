...
class MainActivity : AppCompatActivity() {
    ...
    private fun configureEdgeToEdgeWindow() {
        ...
        applySystemBarTheme(darkTheme = true)
    }
    ...
    private fun applyWindowInsets(root: android.view.View) {
        ViewCompat.setOnApplyWindowInsetsListener(root) { view, insets ->
            ...
            val imeBottom = if (insets.isVisible(WindowInsetsCompat.Type.ime())) {
                maxOf(0, ime.bottom - bars.bottom)
            } else {
                0
            }
            ...
            // Padding the root for system bars created the separate strips seen before.
            // Keep only the additional IME inset while the keyboard is visible.
            ...
            <head>
              ...
              <style>
                *{box-sizing:border-box}body{margin:0;min-height:100vh;display:grid;place-items:center;
                background:#101216;color:#eef2f8;font-family:sans-serif;padding:28px}.card{text-align:center;
                max-width:430px}.spinner{width:48px;height:48px;margin:0 auto 22px;border:4px solid #2b3442;
                border-top-color:#4da3ff;border-radius:50%;animation:r 1s linear infinite}@keyframes r{to{transform:rotate(360deg)}}
                h2{margin:0 0 10px;font-size:22px}p{margin:0;color:#aeb8c7;line-height:1.7}
              </style>
            </head>
    ...
    private fun showFailurePage(message: String) {
        ...
        val html = """
            ...
            <head>
              ...
              <style>
                *{box-sizing:border-box}body{margin:0;min-height:100vh;display:grid;place-items:center;
                background:#101216;color:#eef2f8;font-family:sans-serif;padding:28px}.card{width:min(100%,460px);
                padding:26px;border:1px solid #303847;border-radius:20px;background:#191d24}h2{margin:0 0 12px}
                p{color:#aeb8c7;line-height:1.65;overflow-wrap:anywhere;white-space:pre-wrap;text-align:left;max-height:55vh;overflow:auto;font-family:monospace;font-size:13px}a{display:inline-block;margin-top:12px;
